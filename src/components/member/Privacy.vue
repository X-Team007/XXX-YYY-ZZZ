...
.viewport-privacy {
        section {
                ...
                .pure-button:hover {
                        color: @theme-font-color-default;
                        font-size: @theme-font-size-common-default * 2.00;
                        font-weight: lighter;
                        line-height: @theme-font-lineheight-common-default * 4.00;
                        background-color: @theme-color-lightgray-lightes;
                        background-image: none;
                        border: @theme-size-border-default * 2.00 @theme-color-lightgray-default solid;
                        box-shadow: none;
                        display: block;
                        width: 7.20rem;
                        height: 2.60rem;
                ...
                .privacy-bottom {
                        ...
                        height: @theme-size-height-default;
                        width: 20.48rem;
                        border: @theme-size-border-default * 2.00 @theme-color-lightgray-default dashed;
                        padding-left: @theme-margin-size-largerm;
                        margin-top: @theme-margin-size-default * 2.00;
                        ...
                        .arrow-up {
                                ...
                                height: 0.00;
                                border-style: dashed;
                                border-width: 0 @theme-margin-size-largerm @theme-margin-size-largerm @theme-margin-size-largerm;
                                border-color: transparent transparent @theme-color-lightgray-default transparent;
                                margin-top: -@theme-font-lineheight-stitle-default * 3.00;

                                &::before {
                                        position: absolute;
                                        content: '';
                                        top: @theme-size-border-default * 2.00;
                                        left: -@theme-margin-size-largerm + @theme-size-border-default;
                                        width: 0.00;
                                        height: 0.00;
                                        border-style: dashed;
                                        border-top-width: 0.00;
                                        border-left-width: @theme-margin-size-largerm - @theme-size-border-default;
                                        border-right-width: @theme-margin-size-largerm - @theme-size-border-default;
                                        border-bottom-width: @theme-margin-size-largerm - @theme-size-border-default;
                                        border-color: transparent transparent @theme-color-white-default transparent;
                                }
                        }
